<?php
$page_title = "Game Development - Dante's Portfolio";
$page_desc  = 'Game Development Experiments - Prototyping with Godot engine and GDScript.';
$page_hero  = 'hero-bg-game';
$hero_title = 'Game Development Experiments';
$hero_subtitle = 'Learning interactive programming vectors, state logic, and design frameworks using the Godot Engine.';
$is_project = true;
